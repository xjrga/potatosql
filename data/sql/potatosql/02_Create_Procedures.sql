CREATE PROCEDURE PUBLIC.DATABASESCHEMA_INSERT (IN V_NAME LONGVARCHAR) SPECIFIC DATABASESCHEMA_INSERT_10134 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.DATABASESCHEMA
(
  SCHEMAID,
  NAME
)
...
CREATE PROCEDURE PUBLIC.DATABASESCHEMA_INSERT (OUT NEWID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC DATABASESCHEMA_INSERT_10135 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.DATABASESCHEMA
(
  SCHEMAID,
  NAME
)
...
END CREATE PROCEDURE PUBLIC.DATABASESCHEMA_UPDATE (IN V_SCHEMAID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC DATABASESCHEMA_UPDATE_10136 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC UPDATE PUBLIC.DATABASESCHEMA
   SET NAME = V_NAME
...
CREATE PROCEDURE PUBLIC.DATABASETABLE_INSERT (IN V_SCHEMAID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC DATABASETABLE_INSERT_10140 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.DATABASETABLE
(
  SCHEMAID,
  TABLEID,
  NAME
...
CREATE PROCEDURE PUBLIC.DATABASETABLE_INSERT (IN V_SCHEMAID INTEGER,OUT NEWID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC DATABASETABLE_INSERT_10141 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.DATABASETABLE
(
  SCHEMAID,
  TABLEID,
  NAME
...
CREATE PROCEDURE PUBLIC.DATABASETABLE_UPDATE (IN V_SCHEMAID INTEGER,IN V_TABLEID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC DATABASETABLE_UPDATE_10142 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC UPDATE PUBLIC.DATABASETABLE
   SET NAME = V_NAME
WHERE SCHEMAID = V_SCHEMAID
...
CREATE PROCEDURE PUBLIC.TABLEKEY_INSERT (IN V_SCHEMAID INTEGER,IN V_TABLEID INTEGER,IN V_NAME LONGVARCHAR,IN V_LABEL LONGVARCHAR,IN V_ISPK BOOLEAN,IN V_TYPEID INTEGER,IN V_Prcsn INTEGER,IN V_SCALE INTEGER,IN V_ORDEN INTEGER) SPECIFIC TABLEKEY_INSERT_10148 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.TABLEKEY
(
  SCHEMAID,
  TABLEID,
  KEYID,
...
CREATE PROCEDURE PUBLIC.TABLEKEY_INSERT (OUT NEWID INTEGER,IN V_SCHEMAID INTEGER,IN V_TABLEID INTEGER,IN V_NAME LONGVARCHAR,IN V_LABEL LONGVARCHAR,IN V_ISPK BOOLEAN,IN V_TYPEID INTEGER,IN V_Prcsn INTEGER,IN V_SCALE INTEGER,IN V_ORDEN INTEGER) SPECIFIC TABLEKEY_INSERT_10323 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.TABLEKEY
(
  SCHEMAID,
  TABLEID,
  KEYID,
...
CREATE PROCEDURE PUBLIC.TABLEKEY_UPDATE (IN V_SCHEMAID INTEGER,IN V_TABLEID INTEGER,IN V_KEYID INTEGER,IN V_NAME LONGVARCHAR,IN V_LABEL LONGVARCHAR,IN V_ISPK BOOLEAN,IN V_TYPEID INTEGER,IN V_Prcsn INTEGER,IN V_SCALE INTEGER,IN V_ORDEN INTEGER) SPECIFIC TABLEKEY_UPDATE_10149 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC UPDATE PUBLIC.TABLEKEY
   SET NAME = V_NAME,
       LABEL = V_LABEL,
       ISPK = V_ISPK,
       TYPEID = V_TYPEID,
...
CREATE PROCEDURE PUBLIC.KEYTYPE_INSERT (IN V_TYPEID INTEGER,IN V_NAME LONGVARCHAR,IN V_PrcsnREQUIRED BOOLEAN,IN V_SCALEREQUIRED BOOLEAN) SPECIFIC KEYTYPE_INSERT_10155 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.KEYTYPE
(
  TYPEID,
  NAME,
  PRECISIONREQUIRED,
...
CREATE PROCEDURE PUBLIC.RELATIONSHIP_INSERT (IN V_SCHEMAID INTEGER,IN V_PARENT_TABLEID INTEGER,IN V_CHILD_TABLEID INTEGER,IN V_RELATIONSHIPTYPEID INTEGER,IN V_NAME LONGVARCHAR,IN V_FORWARDVERBPHRASE LONGVARCHAR,IN V_REVERSEVERBPHRASE LONGVARCHAR) SPECIFIC RELATIONSHIP_INSERT_10158 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.RELATIONSHIP
(
  SCHEMAID,
  PARENT_TABLEID,
  CHILD_TABLEID,
...
CREATE PROCEDURE PUBLIC.RELATIONSHIP_INSERT (OUT NEWID INTEGER,IN V_SCHEMAID INTEGER,IN V_PARENT_TABLEID INTEGER,IN V_CHILD_TABLEID INTEGER,IN V_RELATIONSHIPTYPEID INTEGER,IN V_NAME LONGVARCHAR,IN V_FORWARDVERBPHRASE LONGVARCHAR,IN V_REVERSEVERBPHRASE LONGVARCHAR) SPECIFIC RELATIONSHIP_INSERT_10324 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.RELATIONSHIP
(
  SCHEMAID,
  PARENT_TABLEID,
  CHILD_TABLEID,
...
CREATE PROCEDURE PUBLIC.RELATIONSHIP_UPDATE (IN V_SCHEMAID INTEGER,IN V_PARENT_TABLEID INTEGER,IN V_CHILD_TABLEID INTEGER,IN V_RELATIONSHIPID INTEGER,IN V_RELATIONSHIPTYPEID INTEGER,IN V_NAME LONGVARCHAR,IN V_FORWARDVERBPHRASE LONGVARCHAR,IN V_REVERSEVERBPHRASE LONGVARCHAR) SPECIFIC RELATIONSHIP_UPDATE_10159 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC UPDATE PUBLIC.RELATIONSHIP
...
CREATE PROCEDURE PUBLIC.RELATIONSHIPTYPE_INSERT (IN V_RELATIONSHIPTYPEID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC RELATIONSHIPTYPE_INSERT_10163 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.RELATIONSHIPTYPE
(
  RELATIONSHIPTYPEID,
  NAME
)
...
CREATE PROCEDURE PUBLIC.POTATOSQL_TABLE_COPY (IN V_SCHEMAID INTEGER,IN V_TABLEID_OLD INTEGER,IN V_TABLENAME LONGVARCHAR) SPECIFIC POTATOSQL_TABLE_COPY_10188 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC DECLARE V_TABLEID_NEW INTEGER;
...
CREATE PROCEDURE PUBLIC.DATABASESCHEMA_COPY (IN V_SCHEMAID_OLD INTEGER,IN V_SCHEMANAME_NEW LONGVARCHAR) SPECIFIC DATABASESCHEMA_COPY_10189 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC DECLARE V_SCHEMAID_NEW INTEGER;
...
CREATE PROCEDURE PUBLIC.POTATOSQL_TABLEKEY_COPY (IN V_SCHEMAID INTEGER,IN V_TABLEID INTEGER,IN V_KEYID INTEGER,IN V_NAME LONGVARCHAR) SPECIFIC POTATOSQL_TABLEKEY_COPY_10188 LANGUAGE SQL NOT DETERMINISTIC MODIFIES SQL DATA NEW SAVEPOINT LEVEL BEGIN ATOMIC INSERT INTO PUBLIC.TABLEKEY
(
  SCHEMAID,
  TABLEID,
  NAME,
...
CREATE PROCEDURE PUBLIC.RELATIONSHIP_MULTIPLE_SELECT (
--
