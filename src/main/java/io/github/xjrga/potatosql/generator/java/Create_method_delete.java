...
public class Create_method_delete implements Code {

    private final StringBuilder sqlbuild;
    private final Configuration cfg;
    private final Table table;

    public Create_method_delete(Configuration cfg, Table table) {
        this.cfg = cfg;
        this.table = table;
    ...
    public String get_code() {
        try {
            ...
            Template temp = cfg.getTemplate("create_method_delete.ftl");
