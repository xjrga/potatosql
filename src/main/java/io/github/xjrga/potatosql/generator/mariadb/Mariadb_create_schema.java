...
public class Mariadb_create_schema implements Code {

    private StringBuilder sqlbuild;
    private final String schemaName;
    private Configuration cfg;

    public Mariadb_create_schema(Configuration cfg, String schemaName) {
        this.cfg = cfg;
    ...
    public String get_code() {
        try {
            ...
            Template temp = cfg.getTemplate("create_schema.ftl");
