...
public class Mariadb_create_table_with_select implements Code {

    private StringBuilder sqlbuild;
    private Configuration cfg;
    private Table table;

    public Mariadb_create_table_with_select(Configuration cfg, Table table) {
        this.cfg = cfg;
        this.table = table;
    ...
    public String get_code() {
        try {
            ...
            Template temp = cfg.getTemplate("create_table_with_select.ftl");
