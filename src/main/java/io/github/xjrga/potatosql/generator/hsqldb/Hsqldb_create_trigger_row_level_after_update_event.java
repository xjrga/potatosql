...
public class Hsqldb_create_trigger_row_level_after_update_event implements Code {

    private StringBuilder sqlbuild;
    private Configuration cfg;
    private Table table;

    public Hsqldb_create_trigger_row_level_after_update_event(Configuration cfg, Table table) {
        this.cfg = cfg;
        this.table = table;
