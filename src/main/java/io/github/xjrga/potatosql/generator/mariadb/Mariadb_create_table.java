...
public class Mariadb_create_table implements Code {

    private StringBuilder sqlbuild;
    private Configuration cfg;
    private Table table;

    public Mariadb_create_table(Configuration cfg, Table table) {
        this.cfg = cfg;
        this.table = table;
    ...
    public String get_code() {
        try {
            ...
            Template temp = cfg.getTemplate("create_table.ftl");
