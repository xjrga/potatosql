...
import io.github.xjrga.potatosql.generator.dot.Dot_create_doc;
...
public class DialectBuilder
    ...
    private boolean is_dot_selected;
    ...
    public String get_code() {
        ...
        if ( is_hsqldb_selected ) {
            ...
            sb.append( get_java_code_generated() );
        } else if ( is_dot_selected ) {
            sb.append( get_dot_code_generated_for_graphviz() );
        }
        return sb.toString();
    }
    ...
    public void is_dot_selected( boolean flag ) {
        is_dot_selected = flag;
    }
    ...
    public String get_sql_code_generated_for_hsqldb() {
        ...
        if ( is_tables_and_relationships_selected ) {
            ...
            if ( relationships.size() > 0 ) {
                Hsqldb_create_relationship hsqldb_create_relationship = new Hsqldb_create_relationship( cfg, relationships );
    ...
    public String get_sql_code_generated_for_mariadb() {
        ...
        if ( is_tables_and_relationships_selected ) {
            ...
            if ( relationships.size() > 0 ) {
                Mariadb_create_relationship mariadb_create_relationship = new Mariadb_create_relationship( cfg, relationships );
    ...
    private String get_dot_code_generated_for_graphviz() {
        StringBuilder sb = new StringBuilder();
        TableMaker tableMaker = new TableMaker( dblink );
        List<Table> tables = new ArrayList();
        List<O_select_only_names> relationships = ( List<O_select_only_names> ) dblink.relationship_select_only_names( schema );
        ...
        Dot_create_doc dot_create_doc = new Dot_create_doc( cfg, Utilities.capitalize( schema_name ), tables, relationships );
        sb.append( dot_create_doc.get_code() );
        return sb.toString();
    }
}
