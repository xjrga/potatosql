...
public class Mariadb_create_trigger_row_level_after_update_event implements Code {

    private StringBuilder sqlbuild;
    private Configuration cfg;
    private Table table;

    public Mariadb_create_trigger_row_level_after_update_event(Configuration cfg, Table table) {
        this.cfg = cfg;
        this.table = table;
    ...
    public String get_code() {
        try {
            ...
            Template temp = cfg.getTemplate("create_trigger_row_level_after_update_event.ftl");
