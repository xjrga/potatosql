...
public class Mariadb_create_procedure_delete_all implements Code {

    private StringBuilder sqlbuild;
    private Configuration cfg;
    private Table table;

    public Mariadb_create_procedure_delete_all(Configuration cfg, Table table) {
        this.cfg = cfg;
        this.table = table;
    ...
    public String get_code() {
        try {
            ...
            Template temp = cfg.getTemplate("create_procedure_delete_all.ftl");
