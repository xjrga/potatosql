...
public class DbLink {
    ...
    //Relationship Table
    public void Relationship_Insert(Integer SchemaId, Integer Parent_TableId, Integer Child_TableId, Integer RelationshipTypeId) {
    ...
    public void Relationship_Update(Integer SchemaId, Integer Parent_TableId, Integer Child_TableId, Integer RelationshipId, Integer RelationshipTypeId) {
    ...
    public void Table_Copy(Integer SchemaId, Integer TableId_Old, String Name) {
