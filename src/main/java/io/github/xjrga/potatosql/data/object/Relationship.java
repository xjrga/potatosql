...
public class Relationship {
    ...
    public String toString() {
        return "O_Relationship{Schema_id=" + Schema_id + ", Relationship_id=" + Relationship_id + ", Table_id_parent=" + Table_id_parent + ", Table_id_child=" + Table_id_child + ", Identifying=" + Is_identifying + "}";
    }
    public String print() {
        return toString();
    }
