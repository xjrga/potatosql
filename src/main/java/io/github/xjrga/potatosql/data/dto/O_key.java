...
public class O_key {
    ...
    public String print() {
        return "O_key{" + "Schema_id=" + Schema_id + ", Table_id=" + Table_id + ", Table_key_id=" + Table_key_id + ", Table_key_name=" + Table_key_name + ", Table_key_label=" + Table_key_label + ", Table_key_is_pk=" + Table_key_is_pk + ", Table_key_type_id=" + Table_key_type_id + ", Table_key_order=" + Table_key_order + '}';
    }
