...
public class Relationship_mod {
    ...
    public String toString() {
        return "O_Relationship_mod{" + "Schema_id=" + Schema_id + ", Relationship_id=" + Relationship_id + ", Table_id_parent=" + Table_id_parent + ", Table_id_child=" + Table_id_child + ", Identifying=" + Is_identifying + ", Parent=" + Parent + ", Child=" + Child + '}';
    }
}
