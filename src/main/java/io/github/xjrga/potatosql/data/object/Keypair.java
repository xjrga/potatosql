...
public class Keypair {
    ...
    public String toString() {
        return "O_Relationship_key_pair{Schema_id=" + Schema_id + ", Relationship_id=" + Relationship_id + ", Table_id_parent=" + Table_id_parent + ", Key_id_parent=" + Key_id_parent + ", Table_id_child=" + Table_id_child + ", Key_id_child=" + Key_id_child + "}";
    }
    public String print() {
        return toString();
    }
