...
public class Menu_bar extends JMenuBar {
  ...
  private JMenu get_mnu_exchange() {
    ...
    mnui_import.addActionListener(
        (ActionEvent e) -> {
          event_action_performed_import_xml();
        });
    mnui_export.addActionListener(
        (ActionEvent e) -> {
  ...
  private JMenu get_mnu_output() {
    ...
    mnui_options.addActionListener(
        (ActionEvent e) -> {
  ...
  private void event_action_performed_export_xml() {
    ...
    String format_xml_doc =
        Utilities.format_xml_doc(exporter.apply(mediator.get_schema_selected_value(), path));
  ...
  private void event_action_performed_options() {
    JComponent[] inputs = new JComponent[] {mediator.get_options_panel()};
