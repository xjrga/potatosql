...
public class Output_pnl_composite
        extends JPanel {
    ...
    public Output_pnl_composite( Mediator_concrete mediator ) {
        ...
        btn_copy.addActionListener( ( ActionEvent e )
                -> {
    ...
    private void event_action_performed_btn_generate() {
        ...
        Template_data data = new Template_data( mediator.get_schema_selected_value(), get_template_tables(), get_template_relationships() );
        Coder coder = new Coder();
        mediator.get_code_list_stream().forEach( ( x ) -> sb.append( coder.apply( new File( x.getPath() ), data ) ) );
    ...
    public List<Template_table> get_template_tables() {
        ...
        return table_selector
                .apply( mediator.get_schema_selected_value() ).stream()
