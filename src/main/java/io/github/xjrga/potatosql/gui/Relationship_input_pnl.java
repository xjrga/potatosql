...
public class Relationship_input_pnl extends JPanel {
  ...
  private JPanel get_panel_type() {
    ...
    btnIdentifying.setToolTipText(
        "<html>Child entity is dependent on parent entity for identification and existence.<br>All primary key attributes of parent table become primary key attributes of child table.<html>");
    btnNonIdentifying.setText("Nonidentifying");
    btnNonIdentifying.setToolTipText(
        "<html>Child entity is not dependent on parent entity for identification.<<br>All primary key attributes of parent table become non-primary-key attributes of child table</html>");
