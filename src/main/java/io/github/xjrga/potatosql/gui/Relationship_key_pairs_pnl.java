...
public class Relationship_key_pairs_pnl
        extends JPanel {
    ...
    private JPanel get_relationship_keys_buttons() {
        ...
        btn_add.setText( "+" );
        bnt_delete.setText( "-" );
        btn_add.setToolTipText( "Migrate primary key attribute from parent to child. A primary key attribute is or is part of primary key." );
        ...
        bnt_delete.addActionListener( ( ActionEvent e )
                -> {
    ...
    private void event_action_performed_btn_add() {
        ...
        if ( i == 0 ) {
            ...
            if ( relationship_selected_value.getIs_identifying() ) {
                Identifying_relationship_keypair_ins identifying_insert = new Identifying_relationship_keypair_ins();
                identifying_insert.apply( key_pair );
            } else {
                Nonidentifying_relationship_keypair_ins nonidentifying_insert = new Nonidentifying_relationship_keypair_ins();
    ...
    private void event_action_performed_btn_delete() {
        ...
        if ( relationship_selected_value.getIs_identifying() ) {
            ...
            Nonidentifying_relationship_keypair_del delete = new Nonidentifying_relationship_keypair_del();
            delete.apply( get_relationship_key_pair_selected_value() );
        }
        reload();
        beautify();
